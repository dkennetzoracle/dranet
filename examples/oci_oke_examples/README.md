...
| [BM.GPU.GB300.4 multi-planar](BM.GPU.GB300.4-multiplanar/) | RoCEv2 (4x ConnectX-8 SuperNIC, IPv6 fabric addressed by Router Advertisement) | SLAAC passthrough and IPVLAN rail claims, shared RDMA netns mode, NCCL all_reduce over RoCE and over NVLink (MNNVL via ComputeDomain) |
